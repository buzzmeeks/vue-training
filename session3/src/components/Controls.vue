  ...
  <div class="controls">
    <div class="main">
      ...
      <div class="actions">
        ...
        <button class="actions_button b">B</button>
      </div>
    </div>
    <div class="secondary">
...
.controls {
  ...
  .joystick {
    position: relative;
    width: $joystickButtonSize * 3;
    height: $joystickButtonSize * 3;
    &_button {
